...
namespace WebApisApp.Data.Migrations
{
    ...
    [Migration("20260415101326_HardenSyncSchema")]
    partial class HardenSyncSchema
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebApisApp.Models.SupplierPayment", b =>
                {
                    ...
                    b.Property<Guid>("SupplierPaymentMethodId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("SupplierPaymentMethodId")
                        .HasDatabaseName("IX_SupplierPayments_SupplierPaymentMethodId");
            ...
            modelBuilder.Entity("WebApisApp.Models.SupplierPaymentMethod", b =>
                {
                    b.Property<Guid>("SupplierPaymentMethodId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasKey("SupplierPaymentMethodId");

                    b.HasIndex("SupplierId")
                        .HasDatabaseName("IX_SupplierPaymentMethods_SupplierId");

                    b.HasIndex("SupplierId", "MethodType", "IsActive")
                        .HasDatabaseName("IX_SupplierPaymentMethods_SupplierId_MethodType_IsActive");
            ...
            modelBuilder.Entity("WebApisApp.Models.SupplierPayment", b =>
                {
                    ...
                    b.HasOne("WebApisApp.Models.SupplierPaymentMethod", "PaymentMethod")
                        .WithMany("Payments")
                        .HasForeignKey("SupplierPaymentMethodId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
